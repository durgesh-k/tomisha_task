...
class WebInfoContainer extends StatefulWidget {
  final String para1;
  final String para2;
  final String para3;
  final String image1;
  ...
  @override
  State<WebInfoContainer> createState() => _WebInfoContainerState();
}

class _WebInfoContainerState extends State<WebInfoContainer> {
  @override
      ...
      child: Stack(
        children: [
          Positioned(
              ...
              left: getWidth(context) * 0.24,
              child: Container(
                width: getHeight(context) * 0.25,
              ...
              child: Container(
                ...
                child: Padding(
                  padding: EdgeInsets.only(
                      top: getHeight(context) * 0.0,
                      left: getWidth(context) * 0.20,
